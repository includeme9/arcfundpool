...
export function DesktopNav() {
  ...
  return (
    <header className="sticky top-0 z-40 hidden border-b border-white/10 bg-[#06101f]/88 backdrop-blur-xl md:block">
      <div className="app-container flex min-h-[72px] items-center justify-between py-3">
        ...
        <nav className="flex items-center gap-1 rounded-full border border-white/10 bg-white/[0.025] p-1">
          {links.map((link) => {
            ...
            return (
              <Link
                ...
                href={link.href}
                className={cn(
                  "flex items-center gap-2 rounded-full px-3.5 py-2 text-sm text-[var(--muted)] transition hover:bg-white/[0.05] hover:text-white",
